	...
	<?php
		$querytabel = "select * from galeri LIMIT $start_from, $record_per_page";
		$page_query ="select * from galeri";
	?>
	<body>
	<!-- awal Bagian navbar -->
	...
	<h3><b>Data Galeri</b></h3>
	<hr>
		<div class="col-sm-12">
			<a href="datagaleriTambah.php"><button class="btn btn-success">Tambah Data</button></a>
		</div>
	</div>
	<br>
	<div class="container">
	...
	<table class="table table-bordered" id="konten">
		...
		<tr>
			...
			<th><center>Kode Gambar</center></th>
		...
		?>
			<tr>
			<td><?php echo $baris['kode_gambar']; ?></td>
			<td><center><img src="gambar_galeri/<?php echo $baris['gambar']; ?>" width="100" height="100"/></center></td>
			<td><?php echo date('d-m-Y', strtotime($baris['tanggal'])); ?> </td>
			

			<td>
				<center>
					<a href="datagaleriHapus.php?kode_gambar=<?php echo $baris["kode_gambar"]; ?>"><button class="btn btn-danger">Hapus</button></a>
				</center>
	...
	<?php 
			...
			for ($i=1; $i<=$total_pages; $i++)
				{
				echo '<li class="page-item"><a class="page-link" href="datagaleri.php?page='.$i.'">'.$i.'</a></li>';	
				}
	?>
		</ul> 
	</center>
