	...
	if(isset($_POST['ubah'])){
		if($_POST['password_lama']=="" ||$_POST['password_baru']=="" ||$_POST['konf_password_baru']==""){
			...
			if($_POST['password_baru']===$_POST['konf_password_baru']){
				...
				$query_cek_password = mysqli_query($koneksi,"select * from login where username = '".$_SESSION['username']."' and hak_akses = 'peserta'");
	...
	<div class="container-fluid">   
		...
		<label><h3><b>Ubah Password Anda </b></h3></label>
