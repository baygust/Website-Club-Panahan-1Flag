	...
	<label><h3><b>Data Diri Anda (<?php echo $_SESSION['username']?>)</b></h3></label>
		...
		<form action="" method="post">
			...
			<div class="form-group">
				...
				<input type="text" class="form-control" name="nama" value="<?php echo $hasil_pengajar['nama']; ?>" autocomplete="off" >
			</div>
			<div class="form-group">
				<label>Nomor Telepon Anda : </label>
				<input type="number" class="form-control" name="no_telp" value="<?php echo $hasil_pengajar['no_telp']; ?>" autocomplete="off" >
			</div>
			<div class="form-group">
				<label>Email Anda : </label>
				<input type="email" class="form-control" name="email" value="<?php echo $hasil_pengajar['email']; ?>" autocomplete="off" >
			</div>
			<div class="form-group">
				<label>Alamat Anda : </label>
				<textarea class="form-control" name="alamat" rows="3" autocomplete="off" ><?php echo $hasil_pengajar['alamat']; ?></textarea>
			</div>
			<div class="form-group">
